...
4. 트랙은 약 30×16.35 m의 면적에 들어 갈 것 입니다.
5. 트랙은 매일의 교육 세션이나 각 팀의 예선 세션에서 매핑할 수 있습니다. 팀이 트랙을 매핑할 수 있는 전용 시간 슬롯을 제공합니다. 많은 팀이 SLAM 알고리즘 또는 비전 기반 현지화 기술을 사용하기 때문에, 그 팀을 위한 **전용 맵** 이 제공되지 않습니다.
